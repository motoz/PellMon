...
dataDescriptions = {          #name, unit, description
    ...
    'timer_heating_period':  ('timer heating period', 'min',  ''),
    'timer_hotwater_period': ('timer hotwater period', 'min',  ''),
    'timer_heating_start_1': ('timer heating start 1', 'min',  ''),
    'timer_heating_start_2': ('timer heating start 2', 'min',  ''),
    'timer_heating_start_3': ('timer heating start 3', 'min',  ''),
    'timer_heating_start_4': ('timer heating start 4', 'min',  ''),
    'timer_hotwater_start_1':('timer hotwater start 1', 'min',  ''),
    'timer_hotwater_start_2':('timer hotwater start 3', 'min',  ''),
    'timer_hotwater_start_3':('timer hotwater start 4', 'min',  ''),
