...
def make_barchart_string(db, end, align, div, bars, out='-', width=440, tot_txt='total', avg_unit='', tot_unit='kg'):
    ...
    RrdGraphString1="rrdtool graph "+consumption_file+" --border 1 --disable-rrdtool-tag --full-size-mode --width "+graphWidth+" --right-axis 1:0 --right-axis-format %%1.1lf --height 400 --end %u --start %u-%us "%(now,now,div*bars)
