...
dataDescriptions = {          #name, unit, description
    ...
    'timer_heating_period':  ('timer heating period', 'hh;mm',  'Time period the burner should stay turned on when started by a timer in order to produce heat'),
    'timer_hotwater_period': ('timer hotwater period', 'hh;mm',  'Time period the the burner should stay turned on when started by a timer in order to produce hot water'),
    'timer_heating_start_1': ('timer heating start 1', 'hh;mm',  'Turn on the burner at time'),
    'timer_heating_start_2': ('timer heating start 2', 'hh;mm',  'Turn on the burner at time'),
    'timer_heating_start_3': ('timer heating start 3', 'hh;mm',  'Turn on the burner at time'),
    'timer_heating_start_4': ('timer heating start 4', 'hh;mm',  'Turn on the burner at time'),
    'timer_hotwater_start_1':('timer hotwater start 1', 'hh;mm',  'Turn on the burner at time'),
    'timer_hotwater_start_2':('timer hotwater start 3', 'hh;mm',  'Turn on the burner at time'),
    'timer_hotwater_start_3':('timer hotwater start 4', 'hh;mm',  'Turn on the burner at time'),
